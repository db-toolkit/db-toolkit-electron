    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 pt-24">
      <div className="container mx-auto px-6 py-12">
        ...
        <motion.div {...staggerContainer} className="grid md:grid-cols-2 gap-12 mb-20">
          <motion.div {...fadeInUp(0.3)} className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <motion.div {...fadeInUp(0.4)} className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
        ...
        <motion.div {...staggerContainer} className="grid md:grid-cols-4 gap-8 mb-20">
          <motion.div {...fadeInUp(0.5)} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-center">
          ...
          <motion.div {...fadeInUp(0.6)} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-center">
            <div className="flex justify-center mb-4">
          ...
          <motion.div {...fadeInUp(0.7)} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-center">
            <div className="flex justify-center mb-4">
          ...
          <motion.div {...fadeInUp(0.8)} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-center">
            <div className="flex justify-center mb-4">
